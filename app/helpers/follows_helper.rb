module FollowsHelper
    def link_to_unfollow(follower_id, followee_id)
        icon_options = {
            btn_class: "btn-outline-danger", text: "Unfollow", icon_class: "fas fa-heart text-danger", icon_lock_class: "fas fa-user-slash"
        }
        link_to_icon follows_path(user_id: follower_id, followee_id: followee_id), icon_options, method: "delete" 
    end

    def link_to_follow(follower_id, followee_id)
        icon_options = {
            btn_class: "btn-outline-primary", text: "Follow", icon_class: "far fa-heart text-danger", icon_lock_class: "fas fa-heart text-danger"
        }
        link_to_icon follows_path(user_id: follower_id, followee_id: followee_id), icon_options, method: "post"
    end
